  ...
  return (
    <section id="home">
      <div className="relative min-h-screen bg-white overflow-hidden">
        ...
        <div className="relative max-w-screen-xl z-1 mx-auto px-4 py-20 lg:py-5 xl:px-0">
          <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen">
            {/* Left side - Content */}
            <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
              {/* Badge */}
              <div className="hidden sm:inline-flex items-center w-fit px-4 py-2 mb-1 text-obsidian text-sm font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                <Link
                  to="/register"
                  className="group relative px-8 py-4 bg-blue-velvet text-white font-semibold rounded-full hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-xl cursor-pointer"
                >
                    ...
                    <div className="relative rounded-xl overflow-hidden border border-gray-200/50 shadow-lg h-[400px]">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/70 to-transparent z-2">
                        ...
                        <div className="text-white/80 text-sm">
                          Escaneo de productos, gestión de inventario y más
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center bg-blue-velvet/90 rounded-lg p-3">
                        ...
                        <div>
                          ...
                          <div className="text-gray-300 text-xs">
                            Ofrecer producto complementario
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center bg-teal-tide/90 rounded-lg p-3">
                        ...
                        <div>
                          ...
                          <div className="text-obsidian text-xs">
                            Empleado del mes: María
                          </div>
                        </div>
                      </div>
                    </div>
