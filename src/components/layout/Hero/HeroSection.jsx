  ...
  return (
    <section id="home">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-velvet/15 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-velvet/50 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>

      {/* Grid pattern overlay */}
      <div className="absolute inset-0 opacity-20 bg-[#151932] bg-cover" style={{
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm font-medium">
                  {showPOS ? "Ver Dashboard" : "Ver Punto de Venta"}
                </span>
              </button>
