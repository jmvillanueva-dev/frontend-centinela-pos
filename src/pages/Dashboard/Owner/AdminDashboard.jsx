...
import { Home, Users, FileText, Settings, HelpCircle, Bell, ChevronDown, Plus, UserPlus, ShoppingCart, Package, BarChart2, RefreshCw, Menu, X } from 'lucide-react';
                ...
                <div className="flex flex-col h-full p-4">
                    ...
                    <nav className="flex-1">
                        {[
                            ...
                            { id: 'analytics', icon: <BarChart2 size={18} className="mr-3" />, label: 'Analíticas' },
                            { id: 'employees', icon: <Users size={18} className="mr-3" />, label: 'Empleados' },
                            { id: 'inventory', icon: <Package size={18} className="mr-3" />, label: 'Inventario' },
                            { id: 'settings', icon: <Settings size={18} className="mr-3" />, label: 'Configuración' },
                            { id: 'help', icon: <HelpCircle size={18} className="mr-3" />, label: 'Ayuda' }
                        ].map((item) => (
                            <div 
                                key={item.id}
                    ...
                    <div className="p-4 mt-auto bg-[var(--color-obsidian)]/80 rounded-lg">
                        <div className="text-sm mb-2">Plan actual</div>
                        <div className="font-bold mb-3">Free</div>
                        <button 
                            className="w-full bg-[var(--color-teal-tide)] text-[var(--color-obsidian)] py-2 rounded-lg font-medium hover:opacity-90 transition"
                            onClick={() => toast.info('Próximamente: Actualización a Premium')}
                        >
                            Mejorar a Premium
                        </button>
                    </div>
                ...
                <main className="flex-1 overflow-auto p-4 md:p-6">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            >
                                <Plus size={24} className="mb-2 text-[var(--color-blue-velvet)]" />
                            ...
                            >
                                <UserPlus size={24} className="mb-2 text-[var(--color-blue-velvet)]" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="bg-[var(--color-teal-tide)]/10 p-2 rounded-lg">
                                    <BarChart2 size={20} className="text-[var(--color-teal-tide)]" />
                                </div>
                            </div>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="bg-[var(--color-blue-velvet)]/10 p-2 rounded-lg">
                                    <Users size={20} className="text-[var(--color-blue-velvet)]" />
                                </div>
                            </div>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="text-gray-500 text-sm">Productos en stock</div>
                                    <div className="text-2xl font-bold">342</div>
                                </div>
                                <div className="bg-[var(--color-tangerine)]/10 p-2 rounded-lg">
                                    <Package size={20} className="text-[var(--color-tangerine)]" />
                                </div>
                            </div>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="bg-[var(--color-teal-tide)]/10 p-2 rounded-lg">
                                    <UserPlus size={20} className="text-[var(--color-teal-tide)]" />
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
    <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
      ...
      <div className="sticky top-0 bg-white p-6 border-b flex justify-between items-center">
        <h3 className="text-2xl font-bold text-gray-800">Registrar Nuevo Negocio</h3>
        <button 
      ...
      <form onSubmit={handleBusinessSubmit(registerNewBusiness)} className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {businessErrors.companyName && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.companyName.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {businessErrors.ruc && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.ruc.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <select
                {...registerBusiness('categoria', { required: 'Seleccione una categoría' })}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
              ...
              {businessErrors.categoria && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.categoria.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {businessErrors.telefono && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.telefono.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {businessErrors.direccion && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.direccion.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {businessErrors.emailNegocio && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.emailNegocio.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {businessErrors.descripcion && (
                <p className="mt-1 text-sm text-red-600">{businessErrors.descripcion.message}</p>
              )}
            </div>
          </div>
        </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                        <div className="sticky top-0 bg-white p-4 md:p-6 border-b flex justify-between items-center">
                            <h3 className="text-xl font-bold text-gray-800">Registrar Nuevo Empleado</h3>
                            <button 
                                onClick={() => {
                                    setShowEmployeeModal(false);
                                    resetEmployee();
                        ...
                        <form onSubmit={handleEmployeeSubmit(registerNewEmployee)} className="p-4 md:p-6">
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-1">
