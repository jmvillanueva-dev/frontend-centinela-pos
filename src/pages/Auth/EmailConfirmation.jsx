  ...
  useEffect(() => {
    const verifyEmail = async () => {
      ...
      try {
        ...
        toast.success(
          rol === "jefe"
            ? "Tu cuenta como propietario ha sido verificada correctamente"
            : rol === "administrador"
            ? "Tu cuenta como Administrador ha sido verificada correctamente"
            : "Tu cuenta como empleado ha sido verificada correctamente",
          { autoClose: 5000 }
        );
      ...
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center p-8">
          ...
          <p className="text-gray-600">
            ...
            {rol === "jefe" ? "cuenta de propietario" : "cuenta de empleado"}
          </p>
        </div>
      </div>
    );
      ...
      <div className="relative z-10 w-full max-w-md p-8 space-y-6 bg-obsidian/90 rounded-lg shadow-md animate-fade-in">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-center text-gray-light">
            Tu email de {rol === "jefe" ? "propietario" : rol === "administrador"? "administrador" : "empleado"} ha sido
